<?php
	...
	$emoticons = array(":angry:", ":angry1:", ":bored:", ":bored1:", ":bored2:", ":confused:", ":confused1:", ":crying:", ":crying1:", ":embarrassed:", ":emoticons:", ":happy:", ":happy1:", ":happy2:", ":happy3:", ":happy4:", ":ill:", ":inlove:", ":kissing:", ":mad:", ":nerd:", ":ninja:", ":quiet:", ":sad:", ":secret:", ":smart:", ":smyle:", ":smiling:", ":surprised:", ":surprised1:", ":suspicious:", ":suspiciou1:", ":tongueout:", ":tongueout1:", ":unhappy:", ":wink:");
    ...
    if($conta <= 0){
    	print "<code>A conversa não começará sozinha...</code>";
    }else{
    	while($row = mysqli_fetch_array($result)){
    		$row['mensagem'] = str_replace($emoticons, $images, $row['mensagem']);
?>

<?php  if($row['id_de']==$id_de){?>
<div align="right"><p class="chat-i"><?php print $row['mensagem']; ?></p></div>
<?php }else if($row['id_de']!=$id_de){ ?>
<div align="left"><p class="chat-you"><?php print $row['mensagem']; ?></p></div>
<?php }}} ?>
